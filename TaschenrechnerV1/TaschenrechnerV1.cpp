// TaschenrechnerV1.cpp : Definiert den Einstiegspunkt für die Anwendung.
//
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TASCHENRECHNERV1, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TASCHENRECHNERV1));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_TASCHENRECHNERV1);
